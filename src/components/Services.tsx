      ...
      <div className="w-full px-6 md:px-12 lg:px-24 pb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <article
              key={service.id}
              className="group relative bg-[#111111] hover:bg-[#1a1a1a] border border-white/10 rounded-[24px] flex flex-col justify-start transition-all duration-500 hover:scale-105 hover:z-10 hover:shadow-2xl cursor-pointer overflow-hidden min-h-[420px]"
            >
              {/* Background Image */}
              <div
