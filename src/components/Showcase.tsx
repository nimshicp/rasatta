...
const showcaseWorks = [
  {
    ...
    description: "Also, our driving test methods are on manual cars too",
  ...
  },
  {
    ...
    description: "It was only after doing personal branding that I started getting invited to lead sessions at events.",
  ...
  },
  {
    ...
    description: "If we want to run a business, it won't work without social media.",
  ...
  },
  {
    ...
    description: "The experience of collaborating with the team has been phenomenal.",
  ...
  },
  {
    ...
    client: "DESGRO MEDIA",
    title: "Brand Story",
    description: "Telling stories that resonate with the audience.",
...
export function Showcase() {
  const [selectedWork, setSelectedWork] = useState<typeof showcaseWorks[0] | null>(null);

  // We duplicate the array to create a seamless infinite scroll effect
  const marqueeItems = [...showcaseWorks, ...showcaseWorks, ...showcaseWorks];

  return (
    <section id="work" className="py-24 bg-[#0a0a0a] overflow-hidden relative">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        @keyframes scroll {
          ...
          100% { transform: translateX(-33.3333%); } /* Shifts exactly one set of original items */
        }
        .marquee-track {
          display: flex;
          width: max-content;
      ...
      <div className="px-6 md:px-12 lg:px-24 mb-20 flex flex-col items-start">
        ...
        <p className="text-gray-400 text-lg md:text-xl font-light max-w-2xl">
          A glimpse into the brands we've built, the stories we've told, and the digital experiences we've crafted.
        </p>
      </div>
        ...
        <div className="marquee-track gap-6 px-6">
          {marqueeItems.map((work, index) => (
            <div
              ...
              className="relative w-[280px] md:w-[350px] aspect-[9/16] rounded-2xl overflow-hidden cursor-pointer group flex-shrink-0"
            >
              {/* Background Image */}
              <div
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:scale-110">
          ...
          <div className="relative w-full max-w-5xl h-full max-h-[85vh] bg-[#111] rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="w-full md:w-1/2 h-full p-8 md:p-16 flex flex-col justify-center bg-[#111] overflow-y-auto">
              ...
              <h3 className="text-xl text-gray-400 mb-8 font-light">
                Client: <span className="text-white font-medium">{selectedWork.client}</span>
              </h3>
              ...
              <div className="mt-auto pt-8 border-t border-white/10">
                <p className="text-sm text-gray-500 italic">
                  *This is a detailed view of the work. You can add video players, case study links, or full galleries here.*
                </p>
              </div>
            </div>
